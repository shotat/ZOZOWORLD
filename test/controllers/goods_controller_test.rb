...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { image_url: @good.image_url, name: @good.name, price: @good.price } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { image_url: @good.image_url, name: @good.name, price: @good.price } }
